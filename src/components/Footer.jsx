    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.meunome}>
                <p>Letícia Grazielly</p>
            </div>

            <div className={styles.icons}>
                <a href="https://instagram.com/leticiagrazyyy" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/Grazielly360" target="_blank" rel="noopener noreferrer">
